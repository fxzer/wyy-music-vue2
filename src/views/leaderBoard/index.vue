  ...
  <div   class='leader-board'>
     ...
     <div class="board-top5" v-for="(board,index) in officialBoards" :key="board.id">
      <!-- 榜单封面 -->
        <div class="cover-box">
            ...
            <p class="update-time">{{board.updateTime | formatTime('MM月dd日')}}更新</p>
            <PlayBtn :bgFilter="true" size="large"/>
        </div>
        <!-- 前五歌曲 -->
        <div class="top5-songs">
         <el-table :data="songsTop5List[index]" :show-header="false"   
          ...
          <el-link :underline="false" type="info">查看全部
     ...
     <h2 class="area-title">全球榜</h2>
      <div class="global-board">
          <SongListBox v-for="board in globalBoards" :key="board.id" 
